...
export default function SlideArrowButton({
  text = 'Inscreva-se já!',
  primaryColor = '#afb962', // Default green color
  className = '',
  ...props
  ...
  return (
    <button
      ...
      <span className="relative left-4 z-10 whitespace-nowrap px-8 font-semibold text-gray-700 transition-all duration-200 ease-in-out group-hover:-left-3 group-hover:text-white">
        {text}
      </span>
    </button>
  )
